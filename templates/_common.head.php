...
]; ?><?php # SEO and other optimization ?><meta<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']([], ['name' => 'viewport'], ['content' => 'width=device-width, initial-scale=1'])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /><?php # Third-party dependencies ?><script<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']([], ['src' => 'https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js'], ['defer' => true])
