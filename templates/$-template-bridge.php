...
<?php # Gotta give myself some credit, mate ?><!--  This website was created by Reid Litkauo - reid.litkauo.com
 --><html<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']([], ['lang' => 'en-US'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><head><?php # Uncomment this line to reintroduce WordPress head stuff. ?><?php # wp_head(); ?><?php require_once __DIR__ . "/../templates/_common.head.php"; ?><script<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']([], ['src' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('src', "/static/".(isset($endpoint) ? $endpoint : null).".js")], ['defer' => true])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></script><link<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']([], ['rel' => 'stylesheet'], ['href' => $pugModule['Phug\\Formatter\\Format\\BasicFormat::array_escape']('href', "/static/".(isset($endpoint) ? $endpoint : null).".css")])) ? var_export($_pug_temp, true) : $_pug_temp) ?> /><?php require_once __DIR__ . "/../templates/$endpoint.head.php"; ?></head><body><?php require_once __DIR__ . "/../templates/_common.body.php"; ?><main><?php require_once __DIR__ . "/../templates/$endpoint.body.php"; ?></main></body></html>