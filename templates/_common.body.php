...
]; ?><div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']([], ['class' => 'sr-only'], ['class' => 'status'], ['aria-live' => 'polite'], ['role' => 'status'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>></div>